        ...
        <div class="wrapper">
          <article class="col1">
            ...
            <div class="pad_left1">
              <div class="box2">
                <div class="wrapper">
                 ...
                 <article class="col_4 pad_left2">
                     ...
                     <form id="newsletter" name="f" action="userregaction.jsp" method="get" onsubmit="return check()">
                  <div class="wrapper">
                    <div class="bg">
              ...
              <a href="datauser.jsp" class="button"><span><span>Back</span></span></a> </article>
